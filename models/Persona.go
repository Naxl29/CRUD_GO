...
type Persona struct {
	...
	Correo          string `gorm:"type:varchar(100);unique" json:"correo"`
	Direccion       string `gorm:"type:varchar(200)" json:"direccion"`
	Telefono        string `gorm:"type:varchar(15)" json:"telefono"`
}
